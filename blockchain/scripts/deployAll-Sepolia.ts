...
async function deployMarketplace() {
  ...
  console.log(
    "Shopychange Marketplace sepolia network address:",
...
async function deployERC721Factory() {
  ...
  console.log(
    "ShopychangeERC721Factory sepolia network address:",
...
async function deployStorage() {
  ...
  console.log("Storage sepolia network address:", storageContract.address);

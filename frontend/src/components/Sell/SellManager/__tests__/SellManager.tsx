...
jest.mock('../../SellPopoverContent/SellPopoverContent')
...
describe('SellManager', () => {
  test('should open modal', () => {
    ...
    render(<SellManager nft={mockProps.nft} onUpdate={onUpdate} />)
    const buyButton = screen.getByText('Sell')

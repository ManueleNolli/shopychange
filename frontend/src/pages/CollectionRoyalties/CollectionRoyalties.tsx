...
import { CollectionRoyaltiesProps } from '../../types/props/CollectionRoyaltiesProps'
...
export default function CollectionRoyalties({
  address,
}: CollectionRoyaltiesProps) {
  const {
    isFetching,
    isError,
    isUpdateLoading,
    ...
    handleSubmit,
    handleRemoveDefault,
  } = useCollectionRoyalties(address)

  return (
    <Box>
      <QueryContainer isLoading={isFetching} isError={isError}>
        <Center flexDir={'column'}>
          <Heading>Royalties {collection?.name}</Heading>
